...
| D8 | [Journal des décisions](D8-journal-decisions.md) | Continue | Brouillon (n° 1 à 267) | 2026-09-26 |
...
Code du prototype 0 : dossier [`app/`](../app/), publié sur GitHub Pages par [`.github/workflows/pages.yml`](../.github/workflows/pages.yml) (n° 219 à 267). Lots L0.1 à L0.4 : **terminés** (relevés en [D3](D3-plan-de-tests.md) §1.7 ; L0.3 sur le PC, essais iPhone reportés au protocole P0). Lot en cours : L0.5, pertes et preuve : code publié, test sur le PC et l'iPhone 15 Pro à faire ([D6](D6-lots-developpement.md)). Question ouverte sur la parole : [D2](D2-regles-jeu-arbitrage.md) Q17. Vérification automatique : `node --test "tests/*.test.mjs"`.
