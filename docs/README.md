...
| D8 | [Journal des décisions](D8-journal-decisions.md) | Continue | Brouillon (n° 1 à 243) | 2026-09-26 |
...
Code du prototype 0 : dossier [`app/`](../app/), publié sur GitHub Pages par [`.github/workflows/pages.yml`](../.github/workflows/pages.yml) (n° 219 à 243). Lots L0.1 et L0.2 : **terminés** (relevés en [D3](D3-plan-de-tests.md) §1.7). Lot en cours : L0.3, calibrage ([D6](D6-lots-developpement.md)). Vérification automatique : `node --test "tests/*.test.mjs"`.
