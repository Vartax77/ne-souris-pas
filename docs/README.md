...
| D2 | [Règles du jeu et d'arbitrage](D2-regles-jeu-arbitrage.md) | Priorité 1 (arbitrage), Priorité 2 (reste) | Brouillon (complet ; questions ouvertes : Q15, Q16) | 2026-09-26 |
...
| D4 | [Architecture technique](D4-architecture-technique.md) | Priorité 2 | Brouillon (question ouverte : Q11) | 2026-09-26 |
...
| D8 | [Journal des décisions](D8-journal-decisions.md) | Continue | Brouillon (n° 1 à 238) | 2026-09-26 |
...
Code du prototype 0 : dossier [`app/`](../app/), publié sur GitHub Pages par [`.github/workflows/pages.yml`](../.github/workflows/pages.yml) (n° 219 à 238). Lots L0.1 et L0.2 : **terminés** (relevés en [D3](D3-plan-de-tests.md) §1.7). Lot suivant : L0.3, calibrage ([D6](D6-lots-developpement.md)).
