...
| D8 | [Journal des décisions](D8-journal-decisions.md) | Continue | Brouillon (n° 1 à 253) | 2026-09-26 |
...
Code du prototype 0 : dossier [`app/`](../app/), publié sur GitHub Pages par [`.github/workflows/pages.yml`](../.github/workflows/pages.yml) (n° 219 à 253). Lots L0.1, L0.2 et L0.3 : **terminés** (relevés en [D3](D3-plan-de-tests.md) §1.7 ; L0.3 sur le PC, essais iPhone reportés au protocole P0). Lot suivant : L0.4, sourire et jauge ([D6](D6-lots-developpement.md)). Vérification automatique : `node --test "tests/*.test.mjs"`.
