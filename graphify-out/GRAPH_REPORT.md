...
4. `D7 — Documents juridiques et confidentialité` - 11 edges
5. `2. Analyse` - 11 edges
...
## Knowledge Gaps
- **208 isolated node(s):** `1. Principes`, `2. Schéma des composants`, `3. Données qui circulent`, `4.1 Signalisation (appareil ↔ serveur de mise en relation)`, `4.2 Canal de jeu (appareil ↔ appareil)` (+203 more)
...
- **What connects `1. Principes`, `2. Schéma des composants`, `3. Données qui circulent` to the rest of the system?**
